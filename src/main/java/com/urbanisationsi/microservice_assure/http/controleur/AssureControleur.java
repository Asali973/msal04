package com.urbanisationsi.microservice_assure.http.controleur;
...
import com.urbanisationsi.microservice_assure.configuration.ApplicationPropertiesConfiguration;
import com.urbanisationsi.microservice_assure.dao.AssureRepository;
...
public class AssureControleur {
	...
	@ApiOperation(value = "Recherche un assuré par son et prenom à condition que celui-ci existe.")
